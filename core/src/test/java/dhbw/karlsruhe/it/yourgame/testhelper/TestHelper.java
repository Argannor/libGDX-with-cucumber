package dhbw.karlsruhe.it.yourgame.testhelper;
...
import dhbw.karlsruhe.it.yourgame.config.ConfigurationConstants;
...
public class TestHelper {
    ...
    public static void changeScreen(final Screen targetScreen) throws InterruptedException {
    	final YourGame game = (YourGame) Gdx.app.getApplicationListener();
